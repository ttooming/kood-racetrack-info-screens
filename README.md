...
If you see the following, e.g:

v20.11.0 for Node.js or

10.2.3 for npm, you are all set.
...
That generates an address, e.g https://abc123.ngrok.io

Before starting the program, passwords are needed for granting the permission for
employee's interfaces. There are:
...
Declare passwords by exporting them in the terminal, e.g:
